...
- [x] **219 tests pass** on the GitHub Codespace (`bun run test`), typecheck is clean (`bun run typecheck`), and `DRY_RUN=1 bun run pipeline` on a sample image completes with the expected 14 planned Claude calls and zero API cost.
